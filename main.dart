...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _startLesson(String title) {

    debugPrint('changing screen main.dart to lesson.dart');
    Navigator.push(context, MaterialPageRoute(builder: (context) => LessonState(title: title)));
